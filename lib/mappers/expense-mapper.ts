...
export const mapExpenseRecord = (record: UnknownRecord): ExpenseRecord | null => {
  ...
  return {
    ...
    paymentMode: normalizePaymentMode(readStringValue(record, ['paid_from_type', 'paidFromType', 'payment_mode', 'paymentMode'])),
    paidFromType: normalizePaymentMode(readStringValue(record, ['paid_from_type', 'paidFromType', 'payment_mode', 'paymentMode'])),
    paidFrom: readStringValue(record, ['paid_from', 'paidFrom']) || undefined,
