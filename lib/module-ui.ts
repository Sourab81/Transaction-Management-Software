...
export const moduleUi: Record<ModuleUiId, ModuleUiConfig> = {
  ...
  transactions: {
    ...
    emptyDescription: 'Saved inventory transactions will appear here with status, payments, and department details.',
  ...
  services: {
    id: 'services',
    label: 'Inventory',
    emptyTitle: 'No inventory items available yet',
    emptyDescription: 'Add an inventory item to make it available in the transaction workflow.',
    permissionTitle: 'Inventory access is restricted',
    permissionDescription: 'Your current permissions do not allow you to open inventory.',
  },
  accounts: {
    id: 'accounts',
    label: 'Accounts',
  ...
  departments: {
    ...
    emptyDescription: 'Add a department to route inventory, counters, and account activity.',
